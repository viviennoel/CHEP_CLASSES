...
function Signup() {
    ...
    if (user.name === "") {
        ...
        Clear_Style_Signup_Form();
        fetch('https://chep-classes-gv91zjbj1.vercel.app/api/auth/signup', { method: "POST", headers: { 'Content-Type': "application/json" }, body: JSON.stringify(user) }).then(response => response.json()).then(response => user_saved_signup(response))
...
function Login() {
    ...
    fetch('https://chep-classes-gv91zjbj1.vercel.app/api/auth/login', { method: "POST", headers: { 'Content-Type': "application/json" }, body: JSON.stringify(user) }).then(response => response.json()).then(response => user_saved_login(response))
        .catch(function (error) {
